...
import { deepCopy } from "../ktb/util";

function filtrele(mutation, stateBefore, stateAfter) {
  return mutation + stateBefore + stateAfter;
}

export default function createLogger({
  collapsed = true,
  filter = (mutation, stateBefore, stateAfter) => {
    filtrele(mutation, stateBefore, stateAfter);
    return true;
  },
